...
class _ActivationScreenState extends State<ActivationScreen>
  ...
  Future<void> _submitAuth() async {
    ...
    // التوثيق الصارم من خلال الفورم (يمنع تجاوز إدخال الاسم عند إنشاء الحساب)
    ...
    try {
      ...
      if (_isLoginMode) {
        // حالة تسجيل الدخول: نعتمد على التحقق من فايربيس فقط
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          // استخدام RadioGroup الجديد من Flutter (Material 3)
          RadioGroup<String>(
              ...
              children: [
                Expanded(
                  child: RadioListTile<String>(
                    ...
                    value: 'university',
                    // تم حذف groupValue و onChanged من هنا لأنهما يُداران بواسطة RadioGroup
                  ),
                ),
                Expanded(
                  child: RadioListTile<String>(
