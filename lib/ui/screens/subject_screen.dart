...
import 'subject_ai_tutor_screen.dart';
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => Navigator.push(
              context,
              MaterialPageRoute(
                builder: (_) => SubjectAiTutorScreen(
                  field: widget.field,
                  year: widget.year,
                  subject: widget.subject,
                ),
    ...
    return SizedBox(
      ...
      child: Column(
        children: [
          ...
          Text(label, textAlign: TextAlign.center, style: const TextStyle(fontSize: 12), maxLines: 1, overflow: TextOverflow.ellipsis,),
        ],
      ),
    );
  }
