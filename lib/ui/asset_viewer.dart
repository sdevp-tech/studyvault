...
class _AssetViewerState extends State<AssetViewer> {
  ...
  void _initializeVideoPlayer() {
    _videoController = VideoPlayerController.file(File(widget.asset.resolvedFilePath))
      ..initialize().then((_) {
  ...
  Future<void> _openExternally() async {
    await OpenFile.open(widget.asset.resolvedFilePath);
  }
        ...
        children: [
          Container(
            ...
            child: RotatedBox(
              ...
              child: PhotoView(
                imageProvider: FileImage(File(widget.asset.resolvedFilePath)),
  ...
  Widget _buildTextViewer() {
    final local = AppLocalizations.of(context);
    try {
      final file = File(widget.asset.resolvedFilePath);
